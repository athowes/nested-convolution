...
In this example we follow the nested model [eggs example](https://people.bath.ac.uk/jjf23/mixchange/nested.html) of Julian Faraway, who provides code to fit the model in (amongst other things) `R-INLA` and `rstan`.
